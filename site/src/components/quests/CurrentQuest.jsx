export const CurrentQuest = ({ lang }) => (
    <div className='questContent'>
        ...
        {lang === 'EN' ? (
            ...
            <div>
                {/* French content */ }
                En tant que membres du club de robotique de Daw-Tec, nous assurons la prospérité de l&apos;Abri 25 en promouvant l&apos;utilisation de la technologie pour les activités de loisirs. Il est prouvé que la stimulation du cerveau humain est le moyen le plus efficace de préparer l&apos;humanité à sa réintégration dans le monde extérieur. Avec l&apos;aide de Pax, Avi et Jacob, Robotique Daw-Tec s&apos;est considérablement développée et le club est sur le point d&apos;achever son nouvel instrument qui aidera l&apos;équipe à se rendre à la compétition CRC de cette année.
